                ...
                <TableContainer component={Paper} elevation="3" style={{backgroundColor: "#fdfdfd"}}>
                    <Table>
                        <TableHead className={classes.tbhead}>
                            <TableRow>
                                <TableCell align="center" colSpan="5" style={{ fontWeight: 600, fontSize: 16}}>CANDIDATES</TableCell>
                            </TableRow>
                            <TableRow>
                        ...
                        <TableBody>
                            {
                                (typeof props.candidates === 'undefined')?(
                                    <TableRow>
                                        <TableCell align="center" colSpan="5" >No candidates enrolled.</TableCell>
                                    </TableRow>
